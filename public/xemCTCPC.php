...
<script>
    $(document).ready(function () {
        ...
        function fetchOrderDetails() {
            ...
            fetch(`http://localhost/WEB_ThueHoTroKhamBenh/api/xemCPCCTAPI.php?id=${orderId}`, {
                method: 'GET',
    ...
    <div class="order-card bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <div class="mt-4 flex justify-center gap-4">
            <a href="phancongDH.php" class="inline-block bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
